...
void initialise_tasking()
{
    ...
    current_task->fds_count = 1024;
    current_task->fds=(fs_node_t**)kmalloc(sizeof(fs_node_t*)*current_task->fds_count);
    current_task->fds[0] = console_tty;
    current_task->fds[1] = console_tty;
    current_task->fds[2] = console_tty;
...
void move_stack(void *new_stack_start, u32int size)
{
  ...
  // Copy the stack.
  k_memcpy((void*)new_stack_pointer, (void*)old_stack_pointer, initial_esp-old_stack_pointer);
